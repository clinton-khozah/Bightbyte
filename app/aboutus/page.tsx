        ...
        <div className="py-6 md:py-20">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto px-2 md:px-0">
              ...
              <p className="text-xs md:text-lg text-white font-['Verdana',sans-serif] leading-relaxed drop-shadow-md mb-6 md:mb-12">
              ...
              <div className="mt-6 md:mt-12 text-left">
                ...
                <div className="max-w-4xl mx-auto">
                  <p className="text-xs md:text-base text-white font-['Verdana',sans-serif] leading-relaxed drop-shadow-sm">
          ...
          >
            ...
            >
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-4 md:p-12 border-2 border-yellow-400/30 shadow-2xl">
                <div className="space-y-3 md:space-y-6 text-white font-['Verdana',sans-serif] leading-relaxed text-xs md:text-xl">
